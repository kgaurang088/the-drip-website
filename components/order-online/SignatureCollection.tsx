  ...
  return (
    <section className="bg-[#0B0B0B] py-24">
      ...
      <div className="container-custom">
        <div className="mx-auto mb-20 h-px w-48 bg-gradient-to-r from-transparent via-[#C8A96A]/40 to-transparent" />
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          ...
          {signatureItems.map((item) => (
            ...
            <div
              key={item.name}
             className="group overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-br from-[#181818] via-[#151515] to-[#101010] transition-all duration-500 hover:-translate-y-3 hover:border-[#C8A96A] hover:shadow-[0_20px_60px_rgba(200,169,106,0.15)]"
            >

              <div  className="relative flex h-80 items-center justify-center overflow-hidden bg-[#101010]">
                    {/* Golden Glow */}
