...
export default function OurStory() {
  return (
    <section className="relative overflow-hidden py-28 bg-[#0B0B0B]">

      {/* Background Glow */}

      <div className="absolute inset-0 -z-10 overflow-hidden">

        <div className="absolute left-[-200px] bottom-[-120px] h-[500px] w-[500px] rounded-full bg-[#C8A96A]/5 blur-[180px]" />
      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-24 items-center">
          ...
          <div className="group relative">
            ...
            <div className="relative rounded-[36px] border border-white/10 bg-gradient-to-br from-[#181818] via-[#151515] to-[#101010] p-8 transition-all duration-700 hover:-translate-y-2 hover:border-[#C8A96A]/40">

              <div className="relative h-[560px] overflow-hidden rounded-[28px] bg-[#101010]">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  ...
                  <img
                    src="/logo.png"
                    alt="The Drip"
                    className="h-36 w-36 object-contain transition-all duration-700 group-hover:scale-110"
                  />
          ...
          <div>
            ...
            <div className="mt-12 rounded-[28px] border border-[#C8A96A]/20 bg-[#151515] p-8">
