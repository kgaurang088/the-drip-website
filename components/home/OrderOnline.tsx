...
export default function OrderOnline() {
  return (
    <section className="section bg-[#0B0B0B]">
      ...
      <div className="container-custom">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-8">
          ...
          <a
            ...
            className="group rounded-[32px] border border-white/10 bg-[#151515] p-10 transition-all duration-500 hover:-translate-y-2 hover:border-[#C8A96A]"
          >
            ...
            <div className="mt-10 flex items-center gap-2 text-[#C8A96A] font-semibold">
